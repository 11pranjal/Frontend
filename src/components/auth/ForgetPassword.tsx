...
export default function ForgetPasswordPage() {
 ...
 <div className="flex w-full justify-center">
        <a href="/" className="cursor-pointer hover:underline  transition hover:scale-96 w-full p-2 rounded-full border border-emerald-800 text-green-950 text-lg text-center">
 Login here
</a>
 </div>
