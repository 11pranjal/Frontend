...
export default function LoginPage() {
 ...
 <div className="flex w-full justify-center">
        <a href="/register" className="cursor-pointer hover:underline  transition hover:scale-96 w-full p-2 rounded-full border border-emerald-800 text-green-950 text-lg text-center">
 Register here
</a>
 </div>
