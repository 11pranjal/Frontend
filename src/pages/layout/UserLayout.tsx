            ...
            <header className="h-20 bg-gray-900 w-full text-white">
                <div className="flex items-center justify-between px-6 h-full">
                    ...
                    <div className="flex items-center gap-4">
                        <button className="hover:bg-gray-700 px-3 py-2 rounded">Profile</button>
                        <button className="hover:bg-gray-700 px-3 py-2 rounded">Logout</button>
                    </div>
                </div>
                </header >
                <main className="flex w-full h-screen">
                    <aside className="bg-gray-800 text-white w-100">
                        <nav className="p-4 space-y-2">
                            <a href="#" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-700 transition">
                                <span>📊</span>
                                <span>Dashboard</span>
                            </a>
                            <a href="#" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-700 transition">
